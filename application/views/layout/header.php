						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="<?=base_url()?>loginn/login">Register or Login</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									<li class="active"><a href="<?=base_url()?>TrainingCenter/cek">Home</a></li>
									<li><a href="<?=base_url()?>TrainingCenter/kategori">Job Information</a></li>
									<li><a href="<?=base_url()?>TrainingCenter/paket">Apply Job</a></li>
									<li><a href="<?=base_url()?>TrainingCenter/contact">Contact Us</a></li>
								</ul>
